...
def print_cli_usage():
  ...
  print "  c|Control the bulb using the protocol"
    ...
    if argv[0] == "q" or argv[0] == "quit":
      ...
      if len(argv) != 3:
        ...
        try:
          ...
          valid_cli=False
    elif argv[0] == "c" or argv[0] == "control":
        try:
          idx = int(float(argv[1]))
          print "idx", idx
          command=" ".join(argv)
          print command
          operate_on_bulb(idx, "set_rgb", "1677715\", \"smooth\",500") #16777215
          #params="\"smooth\"", params="1,\"smooth\",80"
        except:
          valid_cli=False
    else:
      valid_cli=False
